...
<body>
	...
	<div class="centered1">
			<button disabled="disabled" class='tab-on'>회원약관</button>
						...
						<tbody>
							...
							<tr id="accordion">
								<td align="center" valign="top"><textarea
										style="width: 98%" rows="10" readonly="readonly">제  1 장 : 총칙 
제 2 장 : 서비스 이용계약 
제 3 장 : 계약당사자의 의무 
제 4 장 : 서비스 이용 
제 5 장 : 계약해지 및 이용제한 
...
(시행일) 이 약관은 2014년 5월 1일부터 시행합니다.
					...
					<table width="100%" cellpadding="4" cellspacing="0"
						...
						<tbody>
							...
							<tr id="accordion">
								<td align="center" valign="top"><textarea
										style="width: 98%" rows="10" readonly="readonly">'One Green Korea Movement'은 (이하 '단체'는)
...
신용정보의 수집/처리 및 이용 등에 관한 기록 : 3년 (신용정보의 이용 및 보호에 관한 법률)
		...
		<br />
						...
						<div align=center>
							<button type="button" class='btn btn-info ' style="width: 130px" onclick="location.href='join'" >동의</button>
							<button type="button" class='btn btn-outline-secondary ' style="width: 130px" onclick="location.href='${pageContext.request.contextPath }'" >동의 안 함</button>
						</div>
